...
def bleu_compute(hypothesis, reference):
...
def rouge_compute(hypothesis, reference):
    rouge = Rouge()
    rouge_score = rouge.get_scores(reference, hypothesis)
    return rouge_score
...
def main(self):
    ...
    eval_result = classifier.evaluate(input_fn=lambda: data.eval_input_fn(
        eval_input_enc, eval_input_dec, eval_target_dec, DEFINES.batch_size))  ##eval_input_fn
